...
const test_product = {
  ...
  currency: "EUR",
  description: {
    en: "Temporary 0.50 EUR test product for checking out the real Stripe payment flow (card, Apple Pay, Google Pay) end to end. Remove before launch.",
    sk: "Dočasný testovací produkt za 0,50 €, na overenie reálneho platobného procesu (karta, Apple Pay, Google Pay) od začiatku do konca. Pred spustením webu ho odstráň.",
  },
  features: {
    en: ["Test purposes only", "0.50 EUR", "Remove before launch"],
    sk: ["Len na testovanie", "0,50 €", "Pred spustením odstrániť"],
  },
  category: "bags",
  sizes: ["One Size"],
  colors: ["Black"],
