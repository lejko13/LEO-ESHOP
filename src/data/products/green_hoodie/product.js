...
const green_hoodie = {
  ...
  currency: "EUR",
  description: {
    en: "A relaxed, oversized hoodie made from heavyweight brushed cotton in a deep green.",
    sk: "Voľná, oversized mikina z ťažkej česanej bavlny v sýtej zelenej farbe.",
  },
  features: {
    en: [
