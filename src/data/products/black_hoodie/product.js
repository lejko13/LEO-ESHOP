...
const black_hoodie = {
  ...
  currency: "EUR",
  description: {
    en: "A relaxed, oversized hoodie made from heavyweight brushed cotton in a deep black.",
    sk: "Voľná, oversized mikina z ťažkej česanej bavlny v sýtej čiernej farbe.",
  },
  features: {
    en: [
