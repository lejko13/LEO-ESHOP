...
export const translations = {
  en: {
    ...
    contact: {
      ...
      phoneInvalid: "Enter a full, valid phone number.",
      phonePlaceholderLocal: "910 323 325",
      phonePlaceholderOther: "+1 555 123 4567",
      countrySK: "Slovakia (+421)",
      countryCZ: "Czechia (+420)",
      countryOther: "Other",
      message: "Message",
      send: "Send",
      sending: "Sending…",
    ...
    admin: {
      ...
      filterDate: "Filter by day",
      clearFilter: "Show all",
      daySummary: "{count} orders · {total}",
      downloadInvoice: "Download invoice",
      downloadingInvoice: "Downloading…",
      noInvoice: "No invoice",
      invoiceError: "Couldn't download the invoice.",
    },
    seo: {
  ...
  sk: {
    ...
    contact: {
      ...
      phoneInvalid: "Zadajte celé, platné telefónne číslo.",
      phonePlaceholderLocal: "910 323 325",
      phonePlaceholderOther: "+1 555 123 4567",
      countrySK: "Slovensko (+421)",
      countryCZ: "Česko (+420)",
      countryOther: "Iné",
      message: "Správa",
      send: "Odoslať",
    ...
    admin: {
      ...
      dashboardOrders: "Spolu objednávok",
      dashboardRevenue: "Celkový obrat",
      filterDate: "Filtrovať podľa dňa",
      clearFilter: "Zobraziť všetky",
      daySummary: "{count} objednávok · {total}",
      downloadInvoice: "Stiahnuť faktúru",
      downloadingInvoice: "Sťahujem…",
      noInvoice: "Bez faktúry",
      invoiceError: "Faktúru sa nepodarilo stiahnuť.",
    },
    seo: {
      categoryTitle: "{category} — LEO FUDALY",
